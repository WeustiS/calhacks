    ...
    function executeOp$16(node, tensorMap, context) {
        var value = (function (node, tensorMap, context) {
            switch (node.category) {
                ...
                case 'matrices':
                    return tfc.tidy(function () { return executeOp$10(node, tensorMap, context); });
                case 'normalization':
                    return tfc.tidy(function () { return executeOp$11(node, tensorMap, context); });
                case 'reduction':
                    return tfc.tidy(function () { return executeOp$12(node, tensorMap, context); });
                case 'slice_join':
                    return tfc.tidy(function () { return executeOp$13(node, tensorMap, context); });
                case 'spectral':
                    return tfc.tidy(function () { return executeOp$14(node, tensorMap, context); });
                case 'transformation':
                    return tfc.tidy(function () { return executeOp$15(node, tensorMap, context); });
                case 'custom':
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            weightMap = tfc.io.decodeWeights(this.artifacts.weightData, this.artifacts.weightSpecs);
