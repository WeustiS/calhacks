...
const bundle_resource_io_1 = require("./bundle_resource_io");
const tfjsRn = __importStar(require("./platform_react_native"));
const test_env_registry_1 = require("./test_env_registry");
jasmine_util_1.describeWithFlags('BundleResourceIO', test_env_registry_1.RN_ENVS, () => {
    // Test data.
    ...
    it('constructs an IOHandler', async () => {
        ...
        const resourceId = 1;
        const handler = bundle_resource_io_1.bundleResourceIO(modelJson, resourceId);
    ...
    it('errors on string modelJSON', async () => {
      ...
      weightsManifest: [{
        ...
        const resourceId = 1;
        expect(() => bundle_resource_io_1.bundleResourceIO(modelJson, resourceId))
...
//# sourceMappingURL=bundle_resource_io_test.js.map