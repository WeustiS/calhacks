...
CameraComponent) {
    return class CameraWithTensorStream extends React.Component {
        ...
        componentWillUnmount() {
            ...
            if (this.glContext) {
                expo_gl_1.GLView.destroyContextAsync(this.glContext);
            }
            this.camera = null;
            this.glView = null;
            this.glContext = null;
        ...
        async onGLContextCreate(gl) {
            ...
            function* nextFrameGenerator() {
                ...
                while (cameraStreamView.glContext != null) {
                    const imageTensor = camera_1.fromTexture(gl, cameraTexture, textureDims, targetDims);
                    yield imageTensor;
                }
            }
        ...
        previewUpdateFunc(gl, cameraTexture) {
            const renderFunc = () => {
                ...
                const width = react_native_1.PixelRatio.getPixelSizeForLayoutSize(cameraLayout.width);
                const height = react_native_1.PixelRatio.getPixelSizeForLayoutSize(cameraLayout.height);
                const isFrontCamera = this.camera.props.type === expo_camera_1.Camera.Constants.Type.front;
                const flipHorizontal = react_native_1.Platform.OS === 'ios' && isFrontCamera ? false : true;
                camera_1.renderToGLView(gl, cameraTexture, { width, height }, flipHorizontal);
            };
        ...
        render() {
            ...
            if (cameraLayout != null) {
                ...
                glViewComponent = (<expo_gl_1.GLView key='camera-with-tensor-gl-view' style={styles.glView} onContextCreate={this.onGLContextCreate} ref={ref => (this.glView = ref)}/>);
            }
            return [cameraComp, glViewComponent];
        }
    };
}
exports.cameraWithTensors = cameraWithTensors;
//# sourceMappingURL=camera_stream.js.map