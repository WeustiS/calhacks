...
require("./platform_react_native");
// tslint:disable-next-line: no-imports-from-dist
const jasmine_util_1 = require("@tensorflow/tfjs-core/dist/jasmine_util");
const async_storage_io_1 = require("./async_storage_io");
const test_env_registry_1 = require("./test_env_registry");
jasmine_util_1.describeWithFlags('AsyncStorageIO', test_env_registry_1.RN_ENVS, () => {
    // Test data.
    ...
    it('Save-load round trip succeeds', async () => {
        ...
        const handler2 = async_storage_io_1.asyncStorageIO('FooModel');
    ...
    it('Save-load round trip succeeds: v0 format', async () => {
        const handler1 = async_storage_io_1.asyncStorageIO('FooModel');
...
//# sourceMappingURL=async_storage_io_test.js.map