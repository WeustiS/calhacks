	...
	public class facetime_calling_activity extends Activity {
        ...
        private ImageButton icon_awesome_phone_slash;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            icon_awesome_phone_slash = (ImageButton) findViewById(R.id.icon_awesome_phone_slash);

            icon_awesome_phone_slash.setOnClickListener(new View.OnClickListener() {
                @Override
